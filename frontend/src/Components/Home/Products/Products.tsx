...
const Products = () => {
    ...
    return (
        <div className='Products text-xs font-extrabold space-y-9'>
            ...
            {isLoading && <div className="h-44 flex flex-col items-center justify-center mb-8 text-base"><img className="h-32 w-32 object-cover" src={loading} alt=""></img>Loading...</div>}
